...
import { navMenu } from '../../utilits/constant/Constants'
import { Contexts } from '../../context/Context'
import './Navbar.css'

export default function Navbar() {

    const {activeMenu, setActiveMenu, setMdl, setLogin, setSignup} = useContext(Contexts)
    ...
    <div className="nav">
        <div className="container">
            <div className="row align-items justify-content-between small">
                ...
                <div className="col-5 dn">
                    <ul>
                        {
                            navMenu?.map((element, value) => <li key={element.value} className={activeMenu === element ? 'activeNavbarMenu' : ''} onClick={() => handleClickMenu(element)}>{element}</li>)
                        }
                    </ul>
                </div>
                ...
                <div className="col-3 col-lg-4 sdn">
                    <div className="registerBtn">
                        <a href="!#" onClick={() => setLogin(true)}>Log In</a>
